...
class Prediction_Data_validation:
    ...
    def valuesFromSchema(self):
        ...
        try:
            ...
            file = open("D:/Work/Jupyter projects/FSDS work/waferFaultDetection/code/WaferFaultDetection_new/Training_Logs/valuesfromSchemaValidationLog.txt", 'a+')
            filepath = os.path.join("Training_Logs","valuesfromSchemaValidationLog.txt")
